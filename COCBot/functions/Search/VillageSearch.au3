					...
					Else
						...
						If $ichkSkipCollectorCheckIF = 1 Then
							If Number($itxtSkipCollectorGold) <> 0 And Number($itxtSkipCollectorElixir) <> 0 And Number($itxtSkipCollectorDark) <> 0 Then
								If Number($searchGold) >= Number($itxtSkipCollectorGold) And Number($searchElixir) >= Number($itxtSkipCollectorElixir) And Number($searchDark) >= Number($itxtSkipCollectorDark) Then
							...
							ElseIf Number($itxtSkipCollectorGold) <> 0 And Number($itxtSkipCollectorElixir) <> 0 Then
								If Number($searchGold) >= Number($itxtSkipCollectorGold) And Number($searchElixir) >= Number($itxtSkipCollectorElixir) Then
							...
							ElseIf Number($itxtSkipCollectorGold) <> 0 And Number($itxtSkipCollectorDark) <> 0 Then
								If Number($searchGold) >= Number($itxtSkipCollectorGold) And Number($searchDark) >= Number($itxtSkipCollectorDark) Then
							...
							ElseIf Number($itxtSkipCollectorElixir) <> 0 And Number($itxtSkipCollectorDark) <> 0 Then
								If Number($searchElixir) >= Number($itxtSkipCollectorElixir) And Number($searchDark) >= Number($itxtSkipCollectorDark) Then
							...
							ElseIf Number($itxtSkipCollectorGold) <> 0 Then
								If Number($searchGold) >= Number($itxtSkipCollectorGold) Then
							...
							ElseIf Number($itxtSkipCollectorElixir) <> 0 Then
								If Number($searchElixir) >= Number($itxtSkipCollectorElixir) Then
							...
							ElseIf Number($itxtSkipCollectorDark) <> 0 Then
								If Number($searchDark) >= Number($itxtSkipCollectorDark) Then
						...
						If $ichkSkipCollectorCheckIFTHLevel Then
							If $blnFlagSearchAnotherBase Then
								;FindTownhall(True)
								If $searchTH <> "-" Then
									If Number($searchTH) <= $itxtIFTHLevel Then
										SetLog("Target TownHall Level is " & $searchTH & ", lower than or equal my setting " & $itxtIFTHLevel & ", Prepare for attack...", $COLOR_GREEN, "Lucida Console", 7.5)
										$blnFlagSearchAnotherBase = False
									Else
										SetLog("Collectors are not outside, and TownHall Level is " & $searchTH & " Over " & $itxtIFTHLevel & ", skipping search !", $COLOR_RED, "Lucida Console", 7.5)
										;$bDoneCenterZoom = False
									EndIf
								Else
